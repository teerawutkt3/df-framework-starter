		...
		<div class="box box-primary">
			...
			<div class="box-body">
				<div class="row">
					...
					<div class="col-md-1"><nested:text styleClass="form-control" property="formData.code" size="10" maxlength="6" lang="property['รหัสหน้าจอ',required,6,6]" disabled="<%= !editable.booleanValue() %>" /></div>
					<div class="col-md-2 col-md-offset-3"><label class="label-form">ชื่อหน้าจอ</label></div>
					<div class="col-md-2"><nested:text property="formData.name" styleClass="form-control" size="50" maxlength="200" lang="property['ชื่อหน้าจอ',required,,200]" disabled="<%= !editable.booleanValue() %>" /></div>
				</div>
				<div class="row">
					...
					<div class="col-md-2 col-md-offset-2"><label class="label-form">ประเภทหน้าจอ</label></div>
					<div class="col-md-2">
				...
				<div class="row">
					...
					<div class="col-md-2 col-md-offset-2"><label class="label-form">สถานะ</label></div>
					<div class="col-md-2">
			...
			<div class="box-footer">
				<div class="row">
					<div class="col-md-12">
							...
							<input class="btn btn-default" type="button" value=" กลับไป " onclick="doCmd('list')" />
					</div>
				</div>
			</div>
		</div>
